...
#import "LNKGPUImageBeautifyFilter.h"
#import <GPUImage/GPUImage.h>

@interface LNKGPUImageCombinationFilter : GPUImageThreeInputFilter
{
...
@implementation LNKGPUImageCombinationFilter
...
@interface LNKGPUImageBeautifyFilter()
{
    GPUImageBilateralFilter *bilateralFilter;
    GPUImageCannyEdgeDetectionFilter *cannyEdgeFilter;
    LNKGPUImageCombinationFilter *combinationFilter;
...
@implementation LNKGPUImageBeautifyFilter
...
- (id)init;
{
    ...
    // 磨皮 -> 融合
    combinationFilter = [[LNKGPUImageCombinationFilter alloc] init];
